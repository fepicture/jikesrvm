...
public abstract class ReferenceProcessor {
   ...
   *  reachable
   */
  public abstract void scan(ProtonProcessorTracer trace, boolean nursery, boolean retain);
   ...
   */
  public abstract void forward(ProtonProcessorTracer trace, boolean nursery);
