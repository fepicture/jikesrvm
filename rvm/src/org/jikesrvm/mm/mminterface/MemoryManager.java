...
public final class MemoryManager {
  ...
  @Entrypoint
  public static void doProtonProcessorForward(Address traceObjectCallback, Address tracer, boolean isNursery) {
    org.mmtk.vm.VM.protonProcessor.forward(new RustTraceLocal(traceObjectCallback, tracer), isNursery);
  }
